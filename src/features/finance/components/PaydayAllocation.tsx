        ...
        <div className="rounded-2xl border border-black/[0.08] bg-white p-5 shadow-sm h-full flex flex-col justify-between">
            <div className="flex items-center justify-between mb-4">
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 text-[11px] font-bold text-black bg-black/10 px-3 py-1.5 rounded-lg hover:bg-black/20 transition-colors disabled:opacity-50"
                >
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-row gap-3">
                    <div className="relative flex-[1.5]">
                        ...
                        <input
                            ...
                            placeholder="0.00"
                            className="w-full bg-black/[0.03] border border-black/[0.08] rounded-xl pl-8 pr-3 py-2.5 text-[16px] font-bold text-black placeholder-black/20 outline-none focus:border-black/40 transition-colors"
                        />
                    </div>
                    <input
                        type="text"
                        ...
                        placeholder="Source"
                        className="flex-1 min-w-[100px] bg-black/[0.03] border border-black/[0.08] rounded-xl px-3 py-2.5 text-[14px] text-black placeholder-black/20 outline-none focus:border-black/40 transition-colors"
                    />
                </div>
                ...
                <div className="flex flex-row gap-2">
                    <input
                        ...
                        className="w-[120px] shrink-0 bg-black/[0.03] border border-black/[0.08] rounded-xl px-2.5 py-2.5 text-[12px] font-medium text-black outline-none focus:border-black/40 transition-colors"
                    />
