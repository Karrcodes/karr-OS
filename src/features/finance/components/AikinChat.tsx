        ...
        <div className="flex flex-col h-full min-h-[400px]">
            ...
            <div className="flex gap-2 mt-3">
                <input
                    ...
                    className="flex-1 bg-white/[0.04] border border-white/[0.06] rounded-xl px-3.5 py-2.5 text-[13px] text-white/90 placeholder-white/25 outline-none focus:border-[#a78bfa]/40 transition-colors"
                />
                <button
                    onClick={sendMessage}
