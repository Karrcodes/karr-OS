...
export function LinkPreview({ url }: { url: string }) {
    ...
    return (
        <a
            ...
            className="mt-3 block bg-white border border-black/[0.08] rounded-xl overflow-hidden hover:border-black/20 hover:shadow-lg hover:shadow-black/5 transition-all group"
        >
            {data.image && (
            ...
            <div className="p-3">
                <p className="text-[10px] font-bold text-black/40 uppercase tracking-widest mb-1 truncate">{data.siteName}</p>
                <h4 className="text-[13px] font-bold text-black line-clamp-1 mb-1">{data.title}</h4>
                {data.description && (
