                    ...
                    >
                        ...
                        <div className="p-8 border-b border-black/5 flex items-center justify-between shrink-0">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="space-y-0.5">
                                    <h2 className="text-2xl font-black italic tracking-tighter uppercase">Define New Objective</h2>
                                    <p className="text-[10px] font-black text-black/20 uppercase tracking-[0.2em]">Strategic Tactical Layer</p>
                                </div>
                            </div>
                            <button
                                onClick={onClose}
                        ...
                        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8 space-y-8 no-scrollbar">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-black/30 uppercase tracking-[0.2em] ml-1">Goal Designation</label>
                                    <input
                                        autoFocus
                                        value={title}
                                        onChange={e => setTitle(e.target.value)}
                                        placeholder="e.g. Apartment Deposit"
                                        className="w-full text-3xl font-black tracking-tighter placeholder:text-black/5 border-none p-0 focus:ring-0"
                                        required
                                    />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-black/30 uppercase tracking-[0.2em] ml-1">Mission Brief</label>
                                    <textarea
                                        value={description}
                            ...
                            <div className="space-y-4 pt-4 border-t border-black/5">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        <label className="text-[10px] font-black text-black/30 uppercase tracking-[0.2em] ml-1">Milestone Breakdown</label>
                                        <div className="bg-emerald-100 text-emerald-600 rounded-full w-5 h-5 flex items-center justify-center text-[10px] font-black">
                                    ...
                                    <button
                                        ...
                                        className="text-[10px] font-black text-black hover:text-black/60 uppercase tracking-[0.2em] flex items-center gap-1.5 transition-colors"
                                    >
                        ...
                        <div className="p-8 border-t border-black/5 bg-black/[0.01] flex items-center justify-between shrink-0">
                            ...
                            <button
                                ...
                                className={cn(
                                    "flex items-center gap-3 px-10 py-4 bg-black text-white rounded-full font-black italic tracking-tighter uppercase text-lg hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-black/20",
